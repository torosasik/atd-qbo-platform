...
/**
 * Builds a structured prompt for AI validation of a bill.
 *
 * @param {object} data - The bill input data from the app.
...
Review the following vendor bill and evaluate it for accuracy, reasonableness, and potential issues. A bill represents money owed to a vendor for goods or services received.
...
2. Are there any unusually high quantities for a single bill (e.g., hundreds of units for a high-value item)?
...
4. Does this look like it could be a duplicate submission (same vendor, similar amount to a typical recurring bill)? If so, flag it.
