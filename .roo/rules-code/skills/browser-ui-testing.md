...
- Use alongside domain skills (firebase-cloud, qbo-integration, shopify-admin)

## Anti-Loop Rule
If repetitive navigation occurs, force a screenshot + memory update instead of repeating the same action.

This skill makes Roo exceptionally effective at visual UI work across the technologies you use most.
